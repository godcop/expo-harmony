...
| `targetApiVersion` | 旧版别名，建议改用 `expo-build-properties` 的 `targetSdkVersion` |
| `targetSdkVersion` | 数字或 SDK 字符串，默认 `24`，兼容旧 `targetApiVersion` |
| `compatibleSdkVersion` | `20`，不能低于 20，也不能大于 target |
