...
function patchEtsFactorySource(source, descriptors) {
  ...
  const replacements = [
    ...
    [
      ...
      'new ExpoModulesPackage(ctx, expoHarmonyHostProvider, runtimeConfig)',
