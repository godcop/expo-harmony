# @expo-harmony/expo__devtools

为 HarmonyOS 上的 React Native / Expo 项目提供 `@expo/devtools` 的兼容入口。实际 JavaScript 实现由官方包提供。

## 安装

```bash
npm install @expo-harmony/expo__devtools @expo/devtools@55.0.3
```
